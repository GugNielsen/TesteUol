...
namespace TesteUol.Entities
{
    public class ForecastIORequest
    {
        ...
        public ForecastIORequest(string apiKey, double latF, double longF, Unit unit, Language? lang = null, Extend[] extend = null, Exclude[] exclude = null)
        {
            _apiKey = apiKey;
        ...
        public ForecastIORequest(string apiKey, double latF, double longF, DateTime time, Unit unit, Language? lang = null, Extend[] extend = null, Exclude[] exclude = null)
        {
            _apiKey = apiKey;
            _latitude = latF.ToString(CultureInfo.InvariantCulture);
            _longitude = longF.ToString(CultureInfo.InvariantCulture);
